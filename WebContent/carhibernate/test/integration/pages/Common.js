sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("carhibernate/CarHibenateOlingo2/app", ".html");
		...
		return Opa5.extend("carhibernate.CarHibenateOlingo2.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["carhibernate/CarHibenateOlingo2/localService/mockserver"], function (mockserver) {
